/**
 * Referenced @Skadeven Typescript translation from Project 1: https://github.com/CMU-313/NodeBB/pull/237
 */
...
postData: PostObjectNew | null) => void): Promise<PostObjectNew | null> {
    ...
    Posts.setPostField = async function (pid: number, field: string, value: number,
